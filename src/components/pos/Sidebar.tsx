...
import { Coffee, LayoutDashboard, Utensils, History, BarChart3, LogOut, Home, Users } from "lucide-react";
...
export default function StaffSidebar() {
  ...
  return (
    <div className="w-64 bg-neutral-900 border-r border-white/5 flex flex-col h-screen fixed left-0 top-0 z-30">
